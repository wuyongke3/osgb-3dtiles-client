...
export const systemData = [
  { id: 1, name: '批次管理', hasChildren: false, port: 'batch', icon: '', to: '', children: [] },
  { id: 2, name: '矿山云平台', hasChildren: false, port: 'mine', icon: '', to: '', children: [] },
]
...
export const defaultProjectList = [
  { id: 1, name: '伊泰伊犁矿业有限公司', logo_url: 'yitai', checked: false },
]